...
static const KeyAction profileKeyActions[NUM_KEY_PROFILES][ROWS][COLS] = {
  { // Profile 0 - Filmora
    ...
    {{KEY_LEFT_CTRL, KEY_LEFT_ALT, 'c', "/Copia_eff.bmp"}, {KEY_LEFT_CTRL, KEY_LEFT_ALT, 'v', "/Incolla_eff.bmp"}, {KEY_LEFT_CTRL, 0, 'd', "/Duplica.bmp"}, {0, KEY_LEFT_ALT, 'r', "/Rec_Audio.bmp"}},
  ...
  { // Profile 1 - Produzione
    {{KEY_LEFT_CTRL, 0, 'z', "/Annulla.bmp"}, {KEY_LEFT_CTRL, 0, 'y', "/Rifai.bmp"}, {0, 0, KEY_DELETE, "/Cancella.bmp"}, {KEY_LEFT_CTRL, 0, 's', "/Salva.bmp"}},
    {{0, 0, 0, "/OBS.bmp"}, {0, 0, 0, "/Filmora.bmp"}, {0, 0, 0, "/www.bmp"}, {0, 0, 0, "/Calcolatrice.bmp"}},
  ...
  { // Profile 2 - OBS Studio
    ...
    {{KEY_LEFT_CTRL, KEY_LEFT_ALT, '5', "/Mute_mic.bmp"}, {KEY_LEFT_CTRL, KEY_LEFT_ALT, '6', "/Vuota.bmp"}, {KEY_LEFT_CTRL, KEY_LEFT_ALT, '7', "/Vuota.bmp"}, {KEY_LEFT_CTRL, KEY_LEFT_ALT, '8', "/Vuota.bmp"}},
